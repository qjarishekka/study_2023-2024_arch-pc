(define (problem minecraftCraftingTable-problem)
    ...
    (:init
        ...
        (material-in-inventory stick1 inventory)
        (material-in-inventory stick2 inventory)

        (material-in-inventory cobblestone1 inventory)
        (material-in-inventory cobblestone2 inventory)
        (material-in-inventory cobblestone3 inventory)

    )
    (:goal (and
        (planks-placed plank1 slot1)
        (planks-placed plank2 slot2)
        (planks-placed plank3 slot3)
