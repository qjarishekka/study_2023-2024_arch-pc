...
cout<<"введите числа массива"<<endl<<endl;
...
cout << "подсчет производных перестановок:" << cuenta<< endl;   // печатание количества перестановок
...
int salida = 0;
    ...
    for(i=0;i<largo;i++){                                  //сравнение двух функций
...
do{
    ...
    if(izq <= der){                                     //обмен чисел 
       ...
       if(!compare(X,Y,largo)){                         //сравнение массивов
        ...
        counter1++;                                     //увеличиваем на 1 значение переменной
